...
export default function IntroScene({ onComplete }: { onComplete: () => void }) {
  return (
    <div className="relative h-screen w-full bg-neo-pink flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-4 left-4 w-16 h-16 sm:w-28 sm:h-28 md:w-40 md:h-40 border-4 sm:border-8 border-black bg-neo-blue -rotate-12" />
      <div className="absolute bottom-10 right-4 w-20 h-20 sm:w-36 sm:h-36 md:w-56 md:h-56 border-4 sm:border-8 border-black bg-neo-green rotate-12" />
      <div className="absolute top-1/4 right-1/4 w-10 h-10 sm:w-16 sm:h-16 md:w-24 md:h-24 border-4 sm:border-8 border-black bg-neo-yellow rounded-full -rotate-45 hidden sm:block" />
      <div className="absolute bottom-1/4 left-1/4 w-12 h-12 sm:w-20 sm:h-20 md:w-32 md:h-32 border-4 sm:border-8 border-black bg-neo-orange rotate-45 hidden sm:block" />
      ...
      >
        <div className="flex flex-col items-center text-center gap-5 sm:gap-8">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-display font-black uppercase tracking-tighter leading-none">
              DSA <span className="text-neo-blue">MONKEY</span>
            </h1>
            <p className="font-mono text-[10px] sm:text-sm font-bold uppercase bg-neo-yellow inline-block px-2 py-1 border-2 border-black rotate-1">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-4 w-full">
            <div className="border-2 sm:border-4 border-black p-3 sm:p-4 bg-neo-blue/10 text-left transform -rotate-1">
              <Terminal size={18} className="mb-1 sm:mb-2 text-neo-blue" />
            ...
            <div className="border-2 sm:border-4 border-black p-3 sm:p-4 bg-neo-green/10 text-left transform rotate-1">
              <Activity size={18} className="mb-1 sm:mb-2 text-neo-green" />
          ...
          <Button
            onClick={onComplete}
            variant="dark"
            className="w-full py-4 sm:py-6 text-base sm:text-2xl group relative overflow-hidden"
          >
